FROM metabrainz/base-image:bionic-1.0.0-2

ARG CT_VERSION="0.25.1"
...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.metabrainz.based-on-image="metabrainz/base-image:bionic-1.0.0-2" \
      org.metabrainz.consul-template.version="0.25.1"
